...
ข้อมูลที่ใช้ : https://www.kaggle.com/datasets/wellkilo/supermarket-dataset?resource=download
...
1. กราฟเส้นแสดงยอดขายและกำไรในแต่ละปี ซึ่งแสดงให้เห็นว่าทั้งยอดขายและกำไรมักมีแนวโน้มขึ้นลงตามช่วงเวลา และมีบางช่วงที่มีกำไรติดลบ
![image](https://github.com/user-attachments/assets/94ae816e-a5fa-4b3f-a9b3-aebf956392b9)

2. แผนที่แสดงอัตรากำไรในแต่ละรัฐ สามารถเลือกดูตามปีได้ ซึ่งในภาพแสดงข้อมูลของปี 2016 จะเห็นได้ว่ารัฐ Texas, Illinois และ Oregon เป็น 3 รัฐที่มีอัตรากำไรติดลบมากที่สุด
...
4. กราฟแท่งและกราฟเส้นแสดงยอดขายและกำไรแบ่งตามกลุ่มลูกค้า โดยที่ลูกค้ากลุ่ม Consumer มียอดขายและกำไรสูงที่สุด
![image](https://github.com/user-attachments/assets/2f545920-694a-4b8d-8300-b7a57d2ecba4)

5. กราฟเส้นแสดงแนวโน้มของส่วนลดต่ออัตรากำไร จะเห็นได้ว่าเมื่อให้ส่วนลดเพิ่มขึ้น อัตรากำไรจะลดลงอย่างเห็นได้ชัด
